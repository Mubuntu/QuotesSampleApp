...
.config(function($routeProvider) {
    ...
    .factory('quotesSrv', [function() {
     ...
     {
         'id': 2,
         'quotes': ["edadikambo", " intelligent comment here", "its patman bitch"]
     }, {
         'id': 3,
         'quotes': ["sweet christma", " oh booboo toch", "ik ben onderdanig"]
     }, {
         'id': 4,
         'quotes': ["who is this hacker named 4chan", "all hail the king", " the king in the north", "boatsex will be done!"]
     }
 ];
        return {
